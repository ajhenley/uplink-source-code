/* ============================================================
   UPLINK WEB - Screen: Social Security Records
   Searchable social security database. Same pattern as
   criminal/academic records.
   ============================================================ */

const ScreenSocSec = {

    /**
     * Render a social security records screen into the given container.
    ...
    render(container, data) {
        ...
        title.textContent = data.title || 'Social Security Database';
